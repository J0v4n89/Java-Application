...
public class Controller {
    ...
    private Controller() {
        Autor autor1 = new Autor("Ivo", "Andric", 1892, "Biografija autora Ive Andrica bla bla bla");
        Autor autor2 = new Autor("Danilo", "Kiš", 1935, "Biografija Danila Kiša bla bla bla");
        Autor autor3 = new Autor("Meša", "Selimović", 1910, "Meša Selimović je rođen u BiH");

        Knjiga knjiga1 = new Knjiga("Na Drini ćuprija", autor1, "1234567890", 1945, Zanr.ROMAN);
        Knjiga knjiga2 = new Knjiga("Bašta, pepeo", autor2, "0987654321", 1982, Zanr.ROMAN);
        Knjiga knjiga3 = new Knjiga("Tvrđava", autor3, "1122334455", 1970, Zanr.ROMAN);
